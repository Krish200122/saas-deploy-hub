  ...
  if(!empty($_FILES['file_attachment']['name'])) 
  {
    ...
    if (file_exists($target_file)) {
      echo json_encode(
         array(
           "status" => 0,
           "data" => array()
           ,"msg" => "Sorry, file already exists.$Name"
         )
      );
      die();
    }
    ...
    if($Productid == 0){
        ...
        if(mysqli_query($con,$query))
        {
         ...
         $sql = "UPDATE tblproducts SET prdName = '$Productname', prdPrice = $Price ,prdDescription = '$Description',prdCategory = '$catid'  prdImage = 'https://swatnkaquatics.com/assets/images/$Name' WHERE prdId=".$Productid;
