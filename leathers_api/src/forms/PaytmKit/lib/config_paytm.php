...
*/
 ...
 define('PAYTM_MERCHANT_KEY', 'pwaRuBGeVZ99M9o&'); //Change this constant's value with Merchant key received from Paytm.
 define('PAYTM_MERCHANT_MID', 'Stzgjo59882979887769'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (!defined('PAYTM_MERCHANT_MID')) {
    define('PAYTM_MERCHANT_MID', $PAYTM_MERCHANT_MID);
}

if (!defined('PAYTM_MERCHANT_WEBSITE')) {
