...
$sql = "SELECT prdId, prdName, prdsubcatId, tblproducts.fvoriginal, tblproducts.bvoriginal, prdPrice, prdMrp, prdDescription ,CGST , SGST, variantId, varcolorId, colorName, sizeName, varsizeId,  varprdPrice, stock, tblvariantproduct.fvoriginal, tblvariantproduct.fvthumbnail, tblvariantproduct.bvoriginal, tblvariantproduct.bvthumbnail, tblvariantproduct.tvoriginal, tblvariantproduct.tvthumbnail,tblsplOffers.sploffPrice,tblsplOffers.spldate 
        FROM tblproducts 
