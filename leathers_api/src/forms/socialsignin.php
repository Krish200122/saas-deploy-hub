...
if($userprov =="Social"){
    ...
    $sql = "INSERT INTO tblusers(userId, userName, userEmail,userImage, IsAdmin)
            VALUES('$MaxUserId', '$username', '$email', '$userImage', false)";
}else{
     $sql = "INSERT INTO tblusers(userId, userName, userEmail,userImage, userPassword, IsAdmin)
            VALUES('".$MaxUserId."', '".$username."', '".$email."', '".$userImage."', '".$hash."', false)";
}  
